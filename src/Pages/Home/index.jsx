...
const Home = () => {
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
                const res = await axios.get('http://localhost:8000/api/v0.1/user/public_opened'); 
    ...
    const imageMessages = messages.filter(msg => msg.image).sort((a, b) => b.id - a.id).slice(0, 3);
